...
$html .="<table width='100%'>\n"
    ...
    . "</td>\n"
    . "<td>\n"
    . "<p>If this is a remote engagement, the Loop1, LLC engineer will need&nbspVPN access&nbspto the client&rsquo;s environment unless access can be established via the remote meeting session.&nbsp Client should be available as needed during the engagement to facilitate any access needs for the scope of work to be completed within the scheduled time.</p>\n"
    . "</td>\n"
    . "<td>\n"
    . "<p>ALL</p>\n"
    . "</td>\n"
    ...
    . "</td>\n"
    . "<td>\n"
    . "<p>If email based alert actions are wanted, the Orion server(s) must be given permissions within the client&rsquo;s Exchange server or other email relay.</p>\n"
    . "<p>&nbsp</p>\n"
    . "</td>\n"
    . "<td>\n"
    . "<p>ALL</p>\n"
